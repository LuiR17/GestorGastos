<div id="creditCardModal" class="fixed inset-0 bg-black bg-opacity-40 hidden flex items-center justify-center z-50">
    <div class="bg-white p-6 rounded-lg w-96">
        <h1 class="text-2xl font-semibold text-center pb-8">Detalle de la cuenta</h1>
        <h2 id="modalCardname" class="text-xl font-bold mb-2"></h2>
        <input type="text" id="editCardname" class="hidden border rounded-lg w-full mb-2">
        ...
        <button id="closecreditCardModal" class="mt-4 w-full bg-black text-white font-semibold px-4 py-2 rounded-lg hover:bg-gray-900">
            Cerrar
        </button>
